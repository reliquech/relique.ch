...
import { TasksWidget } from "@/admin/tasks/components/TasksWidget";
...
import { dashboardService, type DashboardReport } from "@/admin/dashboard/services/dashboardService";
import { auditLogsService } from "@/admin/dashboard/services/auditLogsService";
import { FunnelSummaryCard } from "@/admin/dashboard/components/FunnelSummaryCard";
import { LeadSourceTable } from "@/admin/dashboard/components/LeadSourceTable";
import { DealAgingTable } from "@/admin/dashboard/components/DealAgingTable";
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-surface border border-border p-6 rounded-xl">
          ...
          {loading && (
            <p className="text-xs text-gray-500 mt-3">Loading chart data...</p>
          )}
        </div>
