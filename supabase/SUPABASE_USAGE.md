...
|--------|------------|----------|---------|-------|
| `alert_rules` | 013_create_notifications_alert_rules.sql | src/app/api/alert-rules/preview/route.ts:141, src/app/api/alert-rules/route.ts:87, src/app/api/alert-rules/route.ts:100, src/app/api/alert-rules/route.ts:141, src/app/api/alert-rules/route.ts:191, src/app/api/alert-rules/route.ts:251, src/app/api/alert-rules/run/route.ts:203, src/app/api/alert-rules/run/route.ts:263, src/app/api/alert-rules/[id]/route.ts:125, src/app/api/alert-rules/[id]/route.ts:162 | **KEEP** | 10 app ref(s) |
...
| `crm_custom_field_values` | 019_create_crm_custom_fields.sql | src/app/api/custom-field-values/route.ts:40, src/app/api/custom-field-values/route.ts:96, src/app/api/custom-field-values/route.ts:109, src/app/api/custom-field-values/route.ts:118 | **KEEP** | 4 app ref(s) |
| `crm_custom_fields` | 019_create_crm_custom_fields.sql | src/app/api/custom-field-values/route.ts:68, src/app/api/custom-fields/export/route.ts:18, src/app/api/custom-fields/import/route.ts:54, src/app/api/custom-fields/import/route.ts:87, src/app/api/custom-fields/import/route.ts:100, src/app/api/custom-fields/route.ts:40, src/app/api/custom-fields/route.ts:82, src/app/api/custom-fields/route.ts:92, src/app/api/custom-fields/[id]/route.ts:46, src/app/api/custom-fields/[id]/route.ts:78 | **KEEP** | 10 app ref(s) |
...
| `pipeline_stages` | 010_create_crm_core.sql | src/app/api/pipeline-stages/route.ts:22, src/app/api/pipeline-stages/route.ts:58, src/app/api/pipeline-stages/[id]/route.ts:25, src/app/api/pipeline-stages/[id]/route.ts:57, src/app/api/pipeline-stages/[id]/route.ts:97 | **KEEP** | 5 app ref(s) |
...
| `tasks` | 018_create_tasks.sql | src/app/api/activity/route.ts:35, src/app/api/alert-rules/run/route.ts:309, src/app/api/tasks/route.ts:67, src/app/api/tasks/route.ts:118, src/app/api/tasks/[id]/route.ts:28, src/app/api/tasks/[id]/route.ts:56, src/app/api/tasks/[id]/route.ts:93 | **KEEP** | 7 app ref(s) |
